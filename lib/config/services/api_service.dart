...
class APIService {
  ...
  Future<Map> getWithoutCallBack(
    ...
    try {
      ...
      if (message != null) {
        ...
        if (showLoader) {
          CBLoader.fail(error: commonError);
        }
        return _response();
      }
  ...
  Future<ApiResponseModel> get({
    ...
    try {
      if (!disableLoading) CBLoader.showLoading();
  ...
  Future<ApiResponseModel> patch({
    ...
    try {
      ...
      if (message.isSuccess) {
        CBLoader.success(message: message.message);
      } else {
        CBLoader.fail(error: message.message);
      }
  ...
  Future<ApiResponseModel> put({
    ...
    try {
      ...
      CBLoader.dismiss();
      if (message.isSuccess) {
        CBLoader.success(message: message.message, duration: 1);
      } else {
        appAlerts.customAlert(
            alertTypes: AlertTypes.error,
            title: 'Error',
